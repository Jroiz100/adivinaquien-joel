// adivina_quien_769.cpp : Joel Roiz Morales
//
...
int main()
{
    ...
    std::cout << " te presento a los personajes \n 1- el jorge es moreno sin pelo y gordo \n 2- ella es alison morena con pelo y muy fit \n 3- joel es blanco con pelo y esta en su peso \n 4- ella es filomena es guera sin pelo y gorda " << std::endl;
    ...
    case 1: cout << "tu personaje es moreno vaya vaya" << endl;
        ...
        case 1:
            ...
            if (respuesta3 == 1)
                cout << "tu personaje es jorge" << endl;
            else
                cout << "mentirosillo" << endl;
    ...
    case 2: cout << "tu personaje es guero vaya vaya" << endl;
        ...
        case 2:
            ...
            if (respuesta3 == 1)
                cout << "tu personaje es filomena" << endl;
            else
                cout << "mentirosillo" << endl;
